  ...
  <tr>
    ...
    <td width="60%">
        ...
        <xsl:if test="./status = 'DF'">
            <form name="changeMessageStatusForm" method="post" action="./change_message_status" onSubmit="return confirm('Are you sure to retry this message?');">Delivery Failure
